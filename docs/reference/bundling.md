...
* Application code is bundled given it's entry point is the `/app.js` and is emitted in `/dist` in a 
...
* The less stylesheets are processed with the `less-loader`, converted to javascript in the bundles
