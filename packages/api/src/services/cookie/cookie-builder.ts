...
export class CookieBuilder {
   ...
   */
  setOptions(options: CookieOptions): CookieBuilder {
   ...
   * @return Returns the current instance for method chaining.
   */
  setExpiration(expiration: number): CookieBuilder {
    const date = new Date();
    date.setTime(date.getTime() + (expiration * CookieBuilder.MILLISECONDS_PER_DAY));
   ...
   * @return Returns the current instance for method chaining.
   */
  setDomain(domain: string): CookieBuilder {
    this.domain = domain;
    return this;
  }
   ...
   * @return Returns the current instance for method chaining.
   */
  setSameSite(sameSite: string): CookieBuilder {
