...
describe('ObjectUtil', () => {
  ...
  describe('deepEqual method', () => {
    test('should return false if the first object is null', () => {
      expect(ObjectUtil.deepEqual(null, obj1)).toBeFalsy();
    });

    test('should return false if the first object is undefined', () => {
      expect(ObjectUtil.deepEqual(undefined, obj2)).toBeFalsy();
    });

    test('should return false if the second object is null', () => {
      expect(ObjectUtil.deepEqual(obj1, null)).toBeFalsy();
    });

    test('should return false if the second object is undefined', () => {
      expect(ObjectUtil.deepEqual(obj1, undefined)).toBeFalsy();
    });

    test('should return false if objects have different constructors', () => {
      expect(ObjectUtil.deepEqual(new Repository(), new RepositoryLocation())).toBeFalsy();
    });

    test('should return false if objects have arrays with different lengths', () => {
      expect(ObjectUtil.deepEqual(obj1, obj3)).toBeFalsy();
    });

    test('should return false if objects have arrays with different objects in them', () => {
      const obj1 = {a: 1, b: {c: [{a: 2}], d: {e: 'hello'}}};
      const obj2 = {a: 1, b: {c: [{a: 3}], d: {e: 'hello'}}};
      expect(ObjectUtil.deepEqual(obj1, obj2)).toBeFalsy();
    });

    test('should return false if objects have arrays with different object lengths in them', () => {
      const obj1 = {a: 1, b: {c: [{a: 2}], d: {e: 'hello'}}};
      const obj2 = {a: 1, b: {c: [{a: 2, b: 2}], d: {e: 'hello'}}};
      expect(ObjectUtil.deepEqual(obj1, obj2)).toBeFalsy();
    });

    test('should return false if one value is an array and the other is not', () => {
    ...
    test('should return true if objects share the same reference', () => {
      const obj2 = obj1;
      expect(ObjectUtil.deepEqual(obj1, obj2)).toBeTruthy();
      expect(obj1).toBe(obj2);
    });

    test('should return true if objects are equal but have different references', () => {
      expect(ObjectUtil.deepEqual(obj1, obj2)).toBeTruthy();
  ...
  describe('hasCopyMethod method', () => {
    test('should return false when checking if primitives have a copy function', () => {
    ...
    test('should return false when checking a non-defined object', () => {
      expect(ObjectUtil.hasCopyMethod(undefined)).toBeFalsy();
      expect(ObjectUtil.hasCopyMethod(null)).toBeFalsy();
    });

    test('should return false when checking an object with a copy property that is not a function', () => {
      expect(ObjectUtil.hasCopyMethod({copy: [1111]})).toBeFalsy();
    });

    test('should return true when checking an object with a copy property that is a function', () => {
  ...
  describe('deepCopy method', () => {
    test('should create a deep copy of an object', () => {
      const obj2: any = ObjectUtil.deepCopy(obj1);
