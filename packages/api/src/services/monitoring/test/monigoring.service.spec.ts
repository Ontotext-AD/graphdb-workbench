...
describe('MonitoringService', () => {
  ...
  test('should fetch and map operations for a specific repository', async () => {
    ...
    TestUtil.mockResponse(new ResponseMock('rest/monitor/repository/123/operations').setResponse(mockOperations));
    ...
    expect(result).toEqual(new OperationStatusSummary(mockOperations));
  });
});
