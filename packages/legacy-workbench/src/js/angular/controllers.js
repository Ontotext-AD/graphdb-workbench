...
function mainCtrl($scope, $menuItems, $jwtAuth, $http, $location, $repositories, $rootScope,
    ...
    function collapsedMenuLogicOnInit() {
        if ($(window).width() <= 720) {
            ...
            $('.main-menu .icon-caret-left').toggleClass('icon-caret-left').toggleClass('ri-arrow-right-s-line');
            $('.toggle-menu').hide();
            ...
            $('.toggle-menu').show();
            $('.main-menu .ri-arrow-right-s-line').toggleClass('ri-arrow-right-s-line').toggleClass('icon-caret-left');
        }
    }
