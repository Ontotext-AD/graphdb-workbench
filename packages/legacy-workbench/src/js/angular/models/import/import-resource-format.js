 ...
 *
 * @type {{Turtle: string, BinaryRDF: string, RDF_XML: string, N3: string, "N-Triples": string, TriX: string, RDF_JSON: string, NDJSON_LD: string, RDF_LD: string, "N-Quads": string, TriG: string}}
 */
