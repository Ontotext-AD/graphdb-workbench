...
PluginRegistry.add('guide.step', [
    ...
    {
        guideBlockName: "ttyg-fts-method-click-disable",
        getSteps: (options, services) => {
            const GuideUtils = services.GuideUtils;
    ...
    {
        guideBlockName: "ttyg-fts-method-click-enable",
        getSteps: (options, services) => {
            const GuideUtils = services.GuideUtils;
            const toggleSelector = GuideUtils.getGuideElementSelector('query-method-fts_search-input');
    ...
    },
    {
        ...
        getSteps: (options, services) => {
            ...
            if (shouldToggleOff) {
                return [{
                    guideBlockName: 'ttyg-fts-method-click-disable', options: {...options}
                }]
            }
            ...
            const steps = [
                ...
                {
                    guideBlockName: 'ttyg-fts-method-click-enable', options: {...options}
                }
            ];
