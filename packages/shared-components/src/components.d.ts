...
import { AuthenticatedUser, AuthenticatedUserResponse, Awaitable, Configuration, GraphConfigList, License, MainMenuPlugin, Notification, OperationStatusSummary, ProductInfo, Repository, RepositoryReference, RepositorySizeInfo, SearchButtonConfig, SecurityConfig, ToastMessage, TranslationParameter, User } from "../../api/dist/ontotext-workbench-api.d";
...
export { AuthenticatedUser, AuthenticatedUserResponse, Awaitable, Configuration, GraphConfigList, License, MainMenuPlugin, Notification, OperationStatusSummary, ProductInfo, Repository, RepositoryReference, RepositorySizeInfo, SearchButtonConfig, SecurityConfig, ToastMessage, TranslationParameter, User } from "../../api/dist/ontotext-workbench-api.d";
