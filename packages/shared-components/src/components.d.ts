...
import { AuthenticatedUser, Awaitable, License, MainMenuPlugin, Notification, OperationStatusSummary, ProductInfo, Repository, RepositoryReference, RepositorySizeInfo, SearchButtonConfig, SecurityConfig, ToastMessage, TranslationParameter } from "../../api/dist/ontotext-workbench-api.d";
...
export { AuthenticatedUser, Awaitable, License, MainMenuPlugin, Notification, OperationStatusSummary, ProductInfo, Repository, RepositoryReference, RepositorySizeInfo, SearchButtonConfig, SecurityConfig, ToastMessage, TranslationParameter } from "../../api/dist/ontotext-workbench-api.d";
