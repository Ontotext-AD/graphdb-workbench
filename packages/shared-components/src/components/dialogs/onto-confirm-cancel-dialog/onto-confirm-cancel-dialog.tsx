...
/**
 * Dialog component used by interactive guides to confirm guide cancellation.
 *
 * The component is shown when a `CONFIRM_CANCEL_EVENT` is dispatched
 * with a `ConfirmCancelPayload`. Once opened, it resolves the selected action
 * (`CANCEL`, `EXIT`, or `DONT_SHOW_AGAIN`) through the callback provided in the payload.
 */
export class OntoConfirmCancelDialog {
  ...
  render() {
    ...
    return (
      <onto-dialog data-test={'confirm-cancel-dialog'} class={'confirm-cancel-dialog'} config={config}>
        <div slot="body">
