...
export class OntoRepositorySelector {
    ...
    return (
      <Host>
        <onto-dropdown
          ...
          dropdownButtonName={<SelectorButton repository={this.currentRepository}
                                              defaultToggleButtonName={this.defaultToggleButtonName}
  ...
  private getRepositoryTooltipFunction(repository: Repository) {
    return () => {
      if (!repository) {
  ...
  private buildRepositoryTooltipHtml(repository: Repository, repositorySizeInfo: RepositorySizeInfo): string {
    ...
    repositoryTooltipHtml += this.buildRepositorySizeInfoHtiml(repositorySizeInfo);

    repositoryTooltipHtml += '</div>';
    return repositoryTooltipHtml
  }

  private buildRepositorySizeInfoHtiml(repositorySizeInfo: RepositorySizeInfo): string {
