...
| `getRepositoryPermission`   | `get-repository-permission`    | Determines whether the current user has write access to the repository. | `(repository: Repository) => RepositoryPermissionType` | `undefined` |
