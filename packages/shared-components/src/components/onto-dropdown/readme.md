...
| ------------------------------- | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------- |
| `autoClose`                     | `auto-close`                        | Flag to determine if the dropdown should close automatically when a click occurs outside the dropdown.                                                                                                                                                                  | `boolean`                                                                                                                                                                                        | `false`                      |
| `disabled`                      | `disabled`                          | Indicates whether the dropdown is disabled.                                                                                                                                                                                                                             | `boolean`                                                                                                                                                                                        | `false`                      |
...
| `tooltipTheme`                  | `tooltip-theme`                     | The tooltip theme to be used for the trigger. For more information {@link OntoTooltipConfiguration#theme }.                                                                                                                                                             | `string`                                                                                                                                                                                         | `undefined`                  |
