...
| `dropdownButtonName`            | `dropdown-button-name`              | The dropdown button name. It will be used if present; otherwise, the {@link OntoDropdown#dropdownButtonNameLabelKey } will be used.       | `string`                                                    | `undefined`                  |
...
| `items`                         | --                                  | Array of dropdown options.                                                                                                                | `DropdownItem[]`                                            | `undefined`                  |
