define(["angular/core/services",
    "angular/queries/controllers"],  function() {



    beforeEach(module('graphdb.framework.jmx.queries.controllers', function($provide) {
    ...
    describe('=> QueriesCtrl tests', function(){
        ...
        beforeEach(inject(function (_$httpBackend_, _$location_, _$controller_, _$window_, _$timeout_, _$interval_, _$repositories_, $rootScope, $q) {
        ...
        describe('$scope.getQueries()', function(){
            it('should set queries correctly', function(){
                ...
                $interval.flush(1001);
                $httpBackend.flush();
                expect($scope.queries).toEqual({"21107": {
                    "queryString":"SELECT ?s ?p ?o\nWHERE {\n\t?s ?p ?o .\n} LIMIT 100567123123123",
                    "trackId":"21107",
