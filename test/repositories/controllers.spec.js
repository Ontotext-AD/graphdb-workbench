    ...
    describe('==> Repository module controllers tests', function () {
        ...
        describe('=> LocationsAndRepositories tests', function () {
            var $repositories,
                ...
                modalServiceMock,
                jwtAuthMock;
            beforeEach(inject(function (_$repositories_, _$httpBackend_, _$location_, _$controller_, _$window_, _$timeout_, $rootScope, $q) {
        ...
        describe('=> AddRepositoryCtrl tests', function () {
            describe('isEnterprice == true', function () {
                ...
                beforeEach(inject(function (_$repositories_, _$httpBackend_, _$controller_, $rootScope) {
                    $repositories = _$repositories_;
                    $httpBackend = _$httpBackend_;
                    $controller = _$controller_;
