define(["angular/repositories/services"],  function($provider) {
    $provider.constant("productInfo", {
        "productType":"standard","productVersion":"7.0","sesame":"2.9.0","connectors":"5.0.0"
    });

	beforeEach(module('graphdb.framework.repositories.services'));
    describe('==> Repository module services tests', function(){
        ...
        describe('=> $repositories tests', function() {
                ...
                beforeEach(inject(function (_$repositories_, _$httpBackend_, _$http_, _$jwtAuth_) {
                    ...
                    httpDefaultUser = $httpBackend.when('GET', 'rest/security/user/admin').respond(200, {username: 'admin', appSettings:  {'DEFAULT_INFERENCE': true, 'DEFAULT_SAMEAS': true, 'EXECUTE_COUNT': true}, authorities: ['ROLE_ADMIN']});
                }));
                ...
                describe('$repositories.deleteLocation', function(){
                    ...
                    it('should delete active location', function(){
                        ...
                        $repositories.init = function(){return};
