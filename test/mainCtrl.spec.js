...
describe('mainCtrl', function () {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $menuItems, _$jwtAuth_, _$http_, _toastr_, _$location_, _$repositories_, _localStorageService_, _productInfo_, _$timeout_, _ModalService_, _$interval_, _$filter_, _LicenseRestService_, _RepositoriesRestService_, _$translate_, _$controller_, _$httpBackend_, $q) {
        ...
        createController = () => $controller('mainCtrl', {
            $scope, menuItems, $jwtAuth, $http, toastr, $location, $repositories, $rootScope, localStorageService, productInfo, $timeout, ModalService, $interval, $filter, LicenseRestService, RepositoriesRestService, $translate
        });
