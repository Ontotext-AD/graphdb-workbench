define(["angular/security/controllers"],  function() {

    beforeEach(module('graphdb.framework.security.controllers'));
    describe('==> Controllers tests', function(){
        ...
        describe('=> LoginCtrl tests', function(){
            ...
            beforeEach(inject(function (_$jwtAuth_, _$httpBackend_, _$location_, _$controller_, _$window_, _$timeout_, _$rootScope_) {
                $jwtAuth = _$jwtAuth_;
        ...
        describe('=> UsersCtrl tests', function(){
            ...
            beforeEach(inject(function (_$jwtAuth_, _$httpBackend_, _$location_, _$controller_, _$timeout_, $rootScope, $q) {
                $jwtAuth = _$jwtAuth_;
                $httpBackend = _$httpBackend_;
                $location = _$location_;
                $controller = _$controller_;
            ...
            describe('$scope.toggleSecurity', function(){
                it('should reload location when toggle to true', function(){
                    $httpBackend.expectGET('rest/security/user');
                    $httpBackend.flush();
                    $jwtAuth.toggleSecurity = function(){return}
                    $jwtAuth.isSecurityEnabled = function(){return true;}
            ...
            describe('$scope.toggleFreeAccess()', function(){
                it('should call $jwtAuth.toggleFreeAccess() on isFreeAccessEnabled == true', function(){
                    $httpBackend.flush();
                    $jwtAuth.isFreeAccessEnabled = function(){return true;}
                ...
                it('should open $modal and call $jwtAuth.toggleFreeAccess() on $modal.close', function(){
                    ...
                    $jwtAuth.isFreeAccessEnabled = function(){return false;}
                    var toggleFreeAccess = {}
        ...
        describe('=> DefaultAuthoritiesCtrl tests', function(){
            ...
            beforeEach(inject(function (_$controller_, $rootScope) {
                ...
                $scope.getActiveLocation = function(){return {uri: ''}}

                var controller = $controller('DefaultAuthoritiesCtrl', { $scope: $scope, $modalInstance: modalInstance,
                    data: {defaultAuthorities: function() {return {}}, appSettings: {}} });
            }));
            ...
            describe('$scope.ok', function(){
                ...
                it('should return correct auth obj on close', function() {
                    ...
                    $scope.appSettings = {'s1': 'v1'}
                    $scope.ok();
                    expect(modalInstance.close).toHaveBeenCalledWith({authorities: ['WRITE_REPO_myrepo', 'READ_REPO_myrepo', 'WRITE_REPO_location2_repo', 'READ_REPO_location2_repo'], appSettings: {'s1': 'v1'}});
                });
                it('should return correct auth obj on close', function() {
                    $scope.grantedAuthorities = {
                    ...
                    $scope.appSettings = {'s1': 'v1'}
                    $scope.ok();
                    expect(modalInstance.close).toHaveBeenCalledWith({authorities: ['WRITE_REPO_myrepo', 'READ_REPO_myrepo', 'WRITE_REPO_location2_repo', 'READ_REPO_location2_repo', 'READ_REPO_myrepo2'], appSettings: {'s1': 'v1'}});
                });
                it('should return correct auth obj on close', function() {
                    $scope.grantedAuthorities = {
                    ...
                    $scope.appSettings = {'s1': 'v1'}
                    $scope.ok();
                    expect(modalInstance.close).toHaveBeenCalledWith({authorities: ['WRITE_REPO_myrepo', 'READ_REPO_myrepo'], appSettings : {'s1': 'v1'}});
                });
            });
        });
        ...
        describe('=> AddUserCtrl tests', function() {
            ...
            beforeEach(inject(function (_$controller_, _$httpBackend_, _$timeout_, $rootScope) {
                $controller = _$controller_;
                $httpBackend = _$httpBackend_;
                $timeout = _$timeout_;
        ...
        describe('=> EditUserCtrl tests', function() {
            ...
            beforeEach(inject(function (_$controller_, _$httpBackend_, _$timeout_, $rootScope) {
                ...
                $scope.getActiveLocation = function(){return {uri: 'locationUri'}}
