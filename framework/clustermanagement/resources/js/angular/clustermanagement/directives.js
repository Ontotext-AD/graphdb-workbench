define([],
    function () {
        ...
        var navigationBarWidthFull = 240;
        var navigationBarWidthCollapsed = 70;
        var navigationBarWidth = navigationBarWidthFull;

        var radius = 24;
        var radius_x = 28;
        var clusterColors = ['#0CB0A0', '#F04E23', '#003663', '#ffcc99', '#99ccff', '#ccff99', '#ff99cc', '#99ffcc'];
        ...
        return clusterManagementDirectives;
    });