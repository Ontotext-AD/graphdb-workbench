define(["angular/export/controllers"], function () {

    beforeEach(module('graphdb.framework.impex.export.controllers'));
    ...
    describe('==> ExportCtrl tests', function () {
        ...
        beforeEach(inject(function (_$jwtAuth_, _$controller_, _$httpBackend_, $rootScope, $q, $injector) {
