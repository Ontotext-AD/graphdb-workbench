define(["angular/import/controllers"], function () {

    beforeEach(module('graphdb.framework.impex.import.controllers', function ($provide) {
    ...
    describe('==> Import module controllers tests', function () {
        describe('= > CommonCtrl tests', function () {
            ...
            beforeEach(inject(function (_$controller_, _$httpBackend_, $rootScope, _$repositories_) {
