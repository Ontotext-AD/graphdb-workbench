define(["angular/core/services",
    ...
    "angular/resources/controllers"],  function() {

    beforeEach(module('graphdb.framework.jmx.resources.controllers', function($provide) {
    ...
    describe('=> ResourcesCtrl tests', function(){
        ...
        beforeEach(inject(function (_$httpBackend_, _$repositories_, _$location_, _$controller_, _$window_, _$timeout_, _$interval_, $rootScope) {
            ...
            $httpBackend.when('GET', 'rest/security/user/admin').respond(200, {username: 'admin', appSettings:  {'DEFAULT_INFERENCE': true, 'DEFAULT_SAMEAS': true, 'EXECUTE_COUNT': true}, authorities: ['ROLE_ADMIN']});
        ...
        describe('$scope.getResourcesData()', function(){
            it('should call function on every 2s', function(){
                $scope.getActiveRepository = function(){return 'activeRepository'}
        ...
        describe('$scope.chartOptions', function(){
            it('should return correct data for Y axis', function(){
                $httpBackend.flush();
                $scope.getActiveRepository = function(){return false}
