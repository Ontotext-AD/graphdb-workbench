define(["angular/core/services",
    ...
    "angular/namespaces/controllers"], function () {


    beforeEach(module('graphdb.framework.namespaces.controllers', function ($provide) {
    ...
    describe('=> NamespacesCtrl tests', function () {
        ...
        beforeEach(inject(function (_$httpBackend_, _$repositories_, _$location_, _$controller_, _$window_, _$timeout_, $rootScope, $q) {
