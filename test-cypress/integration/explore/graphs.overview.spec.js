...
describe('Graphs overview screen validation', () => {
    ...
    it('Export repository in JSONLD format and restore defaults', () => {
    ...
    it('Export repository in JSONLD format with default settings', () => {
        // Given I select to export the repository as JSON-LD
        GraphsOverviewSteps.exportRepository();
        GraphsOverviewSteps.selectJSONLDOption();
    ...
    it('Export repository in JSONLD format using row download button', () => {
        // Given I select to export the repository as JSON-LD
