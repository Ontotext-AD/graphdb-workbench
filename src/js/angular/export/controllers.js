                        ...
                        $timeout(function () {
                            RDF4JRepositoriesRestService.addStatements($repositories.getActiveRepository(), 'update=CLEAR ALL')
                                .then(function () {
                                    ...
                                    $scope.deleting['*'] = false;
                                    if (err.data && err.data === "Clearing all statements in the repository is incompatible" +
                                        " with collecting history. Disable collecting history if you really want to clear all data.") {
