define(["angular/core/services",
    ...
    "angular/clustermanagement/controllers"], function () {

    describe('==> Repository module controllers tests', function () {

        beforeEach(module('graphdb.framework.clustermanagement.controllers', function ($provide) {
        ...
        describe('=> ClusterManagementCtrl tests', function () {
            ...
            describe(' $scope.addOrUpdateLink()', function () {
                it('should return correct data, and set correct linksHash, links and needsToRestart', function () {
                    ...
                    expect($scope.links).toEqual([{source: source, target: target, status: '', timestamp: timestamp, reversePeerMissing: false}]);
